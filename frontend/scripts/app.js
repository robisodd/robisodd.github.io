...
*/
var settings = {
    github_user : 'robisodd', // GitHub username
    metadata : {
        title : "Robisodd's Github Repositories",
        description : 'List of repositories for robisodd (Rob Spiess)',
        url : 'http://robisodd.github.io' // URL where it's going to be published
    }
}
